import React, { Children, isValidElement, cloneElement, useState, useEffect, useCallback, useRef, useMemo, useReducer, createContext, useContext } from 'react';
...
var Icon$q = function (_a) {
    ...
    return (React.createElement(Svg, __assign({ viewBox: "0 0 80 40" }, props),
        React.createElement("image", { width: "80", height: "40", href: isDark ? '/images/egg/logo.png' : '/images/egg/logo.png' })));
};
...
var Dropdown = function (_a) {
    ...
    return (React.createElement(Container, null,
        target,
        React.createElement(DropdownContent, { position: isMobile ? "top" : "bottom" }, children)));
};
...
var Logo = function (_a) {
    var isDark = _a.isDark, props = __rest(_a, ["isDark"]);
    return (React.createElement(Svg, __assign({ viewBox: "0 0 90 70" }, props),
        React.createElement("image", { width: "70", height: "70", href: '/images/egg/logo.png'})));
};
...
var Logo$1 = function (_a) {
    ...
    return (React.createElement(Flex, null, isAbsoluteUrl ? (React.createElement(StyledLink$1, { as: "a", href: href, "aria-label": "Nuts Gaming home page" }, innerLogo)) : (React.createElement(StyledLink$1, { to: href, "aria-label": "Nuts Gaming home page" }, innerLogo))));
};
...
var ConnectModal = function (_a) {
    ...
    return (React.createElement(Modal, { title: t('unlockwallet'), onDismiss: onDismiss }, connectors.map(function (entry, index) { return (React.createElement(WalletCard, { key: entry.title, login: login, walletConfig: entry, onDismiss: onDismiss, mb: index < connectors.length - 1 ? "8px" : "0" })); })));
};
...
var AccountModal = function (_a) {
    ...
    var t = useTranslation().t;
    return (React.createElement(Modal, { title: t('yourwallet'), onDismiss: onDismiss },
        React.createElement(Text, { fontSize: "20px", bold: true, style: { whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis", marginBottom: "8px" } }, account),
        React.createElement(Flex, { mb: "32px" },
            React.createElement(LinkExternal, { small: true, href: "https://bscscan.com/address/" + account, mr: "16px" }, t('viewonbscscan')),
            React.createElement(CopyToClipboard, { toCopy: account }, t('copyaddress'))),
...
styled(Dropdown)(templateObject_1$B || (templateObject_1$B = __makeTemplateObject(["\n  ", " {\n    display: block;\n  }\n\n  display: none;\n"], ["\n  ", " {\n    display: block;\n  }\n\n  display: none;\n"])), function (_a) {
    var theme = _a.theme;
    return theme.mediaQueries.sm;
});
...
var UserBlock = function (_a) {
    ...
    return (React.createElement(Flex, null,
        ...
        React.createElement(StyledButton$1, { size: "sm", color: "white", onClick: function () {
                buy();
            } },
            React.createElement("img", { src: "/images/egg/mastercard.png", width: "60px" })),
        account ? (React.createElement(StyledButton$1, { size: "sm", color: "white", onClick: function () {
                onPresentAccountModal();
            } }, accountEllipsis)) : (React.createElement(StyledButton$1, { size: "sm", onClick: function () {
...
var Pip = styled.div(templateObject_2$c || (templateObject_2$c = __makeTemplateObject(["\n  background-color: ", ";\n  border-radius: 50%;\n  pointer-events: none;\n  height: 8px;\n  position: absolute;\n  right: 0;\n  top: 0;\n  width: 8px;\n"], ["\n  background-color: ", ";\n  border-radius: 50%;\n  pointer-events: none;\n  height: 8px;\n  position: absolute;\n  right: 0;\n  top: 0;\n  width: 8px;\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.failure;
});
...
var StyledNav = styled.div(templateObject_2$d || (templateObject_2$d = __makeTemplateObject(["\n  display: grid;\n  grid-template-columns: 1fr 0px;\n  -webkit-box-pack: justify;\n  justify-content: space-between;\n  -webkit-box-align: center;\n  align-items: center;\n  flex-direction: row;\n  width: 100%;\n  top: 0px;\n  position: relative;\n  z-index: 2;\n"], ["\n  display: grid;\n  grid-template-columns: 1fr 0px;\n  -webkit-box-pack: justify;\n  justify-content: space-between;\n  -webkit-box-align: center;\n  align-items: center;\n  flex-direction: row;\n  width: 100%;\n  top: 0px;\n  position: relative;\n  z-index: 2;\n"])));
var StyledNavLeft = styled.nav(templateObject_3$6 || (templateObject_3$6 = __makeTemplateObject(["\n  top: 0;\n  left: 0;\n  transition: top 0.2s;\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  padding-left: 24px;\n  padding-right: 16px;\n  height: ", "px;\n  z-index: 20;\n  transform: translate3d(0, 0, 0);\n  width: fit-content;\n  @media only screen and (max-width: 960px) {\n    width: 100%\n\t}\n"], ["\n  top: 0;\n  left: 0;\n  transition: top 0.2s;\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  padding-left: 24px;\n  padding-right: 16px;\n  height: ", "px;\n  z-index: 20;\n  transform: translate3d(0, 0, 0);\n  width: fit-content;\n  @media only screen and (max-width: 960px) {\n    width: 100%\n\t}\n"])), MENU_HEIGHT);
var StyledNavRight = styled.nav(templateObject_4$2 || (templateObject_4$2 = __makeTemplateObject(["\n  display: flex;\n  justify-self: flex-end;\n  @media only screen and (max-width: 960px) {\n    position: fixed;\n    bottom: 0;\n    left: 0;\n    transition: bottom 0.2s;\n    width: 100%;\n    justify-content: space-between;\n    align-items: center;\n    height: ", "px;\n    border-top: solid 2px rgba(133, 133, 133, 0.1);\n    z-index: 20;\n    background-color:  ", ";\n\t}\n"], ["\n  display: flex;\n  justify-self: flex-end;\n  @media only screen and (max-width: 960px) {\n    position: fixed;\n    bottom: 0;\n    left: 0;\n    transition: bottom 0.2s;\n    width: 100%;\n    justify-content: space-between;\n    align-items: center;\n    height: ", "px;\n    border-top: solid 2px rgba(133, 133, 133, 0.1);\n    z-index: 20;\n    background-color:  ", ";\n\t}\n"])), MENU_HEIGHT, function (_a) {
    var theme = _a.theme;
...
var StyledNavLink = styled.div(templateObject_8 || (templateObject_8 = __makeTemplateObject(["\n  display: flex;\n  align-items: center;\n  width: fit-content;\n  font-weight 500;\n  color: #C3C5CB;\n  margin: 0px 16px;\n  &:hover {\n    text-decoration: underline;\n  }\n  @media only screen and (max-width: 500px) {\n    display: none;\n\t}\n"], ["\n  display: flex;\n  align-items: center;\n  width: fit-content;\n  font-weight 500;\n  color: #C3C5CB;\n  margin: 0px 16px;\n  &:hover {\n    text-decoration: underline;\n  }\n  @media only screen and (max-width: 500px) {\n    display: none;\n\t}\n"])));
styled.div(templateObject_9 || (templateObject_9 = __makeTemplateObject(["\n  display: flex;\n  align-items: center;\n  width: fit-content;\n  font-size: 1.2rem;\n  font-weight 600;\n  color: #FFFFFF;\n  margin-left: 24px;\n  margin-right: 12px;\n"], ["\n  display: flex;\n  align-items: center;\n  width: fit-content;\n  font-size: 1.2rem;\n  font-weight 600;\n  color: #FFFFFF;\n  margin-left: 24px;\n  margin-right: 12px;\n"])));
var StyledLinkContainer = styled.div(templateObject_10 || (templateObject_10 = __makeTemplateObject(["\n  display: flex;\n  @media only screen and (max-width: 960px) {\n    width: 100%;\n    padding: 1rem 0px 1rem 1rem;\n    justify-content: flex-end;\n\t}\n"], ["\n  display: flex;\n  @media only screen and (max-width: 960px) {\n    width: 100%;\n    padding: 1rem 0px 1rem 1rem;\n    justify-content: flex-end;\n\t}\n"])));
var Icons$1 = IconModule;
Icons$1.MoonIcon; Icons$1.SunIcon; Icons$1.LanguageIcon; var MoreIcon = Icons$1.MoreIcon;
var MobileDropdown = styled(Dropdown)(templateObject_11 || (templateObject_11 = __makeTemplateObject(["\n  ", " {\n    display: block;\n  }\n\n  display: none;\n"], ["\n  ", " {\n    display: block;\n  }\n\n  display: none;\n"])), function (_a) {
    var theme = _a.theme;
    return theme.mediaQueries.sm;
});
var Menu = function (_a) {
    ...
    return (React.createElement(Wrapper$1, null,
        React.createElement(StyledNav, null,
            ...
            React.createElement(StyledNavRight, null,
                React.createElement(Flex, null,
                    React.createElement(UserBlock, { account: account, login: login, logout: logout, buy: buy, toggleTheme: toggleTheme, isDark: isDark, langs: langs, setLang: setLang, currentLang: currentLang }),
