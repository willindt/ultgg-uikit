...
var StyledButton = styled__default['default'].button(templateObject_1$2 || (templateObject_1$2 = __makeTemplateObject(["\n  align-items: center;\n  background-color: ", ";\n  border: ", ";\n  border-radius: 3px;\n  box-shadow: ", ";\n  color: ", ";\n  cursor: pointer;\n  display: inline-flex;\n  font-family: inherit;\n  font-size: 16px;\n  font-weight: 600;\n  /* max-content instead of auto for Safari fix */\n  width: ", ";\n  height: ", ";\n  line-height: 1;\n  letter-spacing: 0.03em;\n  justify-content: center;\n  outline: 0;\n  padding: ", ";\n  margin: ", ";\n  transition: background-color 0.2s;\n  opacity: ", ";\n\n  &:hover:not(:disabled):not(.button--disabled):not(:active) {\n    background-color: ", ";\n    border-color: ", ";\n  }\n\n  &:focus:not(:active) {\n    box-shadow: 0 0 0 2px ", ";\n  }\n\n  &:active {\n    background-color: ", ";\n    box-shadow: ", ";\n  }\n\n  ", "\n  ", "\n  ", "\n"], ["\n  align-items: center;\n  background-color: ", ";\n  border: ", ";\n  border-radius: 3px;\n  box-shadow: ", ";\n  color: ", ";\n  cursor: pointer;\n  display: inline-flex;\n  font-family: inherit;\n  font-size: 16px;\n  font-weight: 600;\n  /* max-content instead of auto for Safari fix */\n  width: ", ";\n  height: ", ";\n  line-height: 1;\n  letter-spacing: 0.03em;\n  justify-content: center;\n  outline: 0;\n  padding: ", ";\n  margin: ", ";\n  transition: background-color 0.2s;\n  opacity: ", ";\n\n  &:hover:not(:disabled):not(.button--disabled):not(:active) {\n    background-color: ", ";\n    border-color: ", ";\n  }\n\n  &:focus:not(:active) {\n    box-shadow: 0 0 0 2px ", ";\n  }\n\n  &:active {\n    background-color: ", ";\n    box-shadow: ", ";\n  }\n\n  ", "\n  ", "\n  ", "\n"])), getButtonVariantProp("background"), getButtonVariantProp("border"), getButtonVariantProp("boxShadow"), getButtonVariantProp("color"), function (_a) {
    ...
    var size = _a.size;
    return (size === "sm" ? "0 14px" : "0 24px");
}, function (_a) {
    var size = _a.size;
    return (size === "sm" ? "0 5px" : "0");
}, function (_a) {
...
var Icon$q = function (_a) {
    ...
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 80 40" }, props),
        React__default['default'].createElement("image", { width: "80", height: "40", href: isDark ? '/images/egg/logo.png' : '/images/egg/logo.png' })));
};
...
var Dropdown = function (_a) {
    var target = _a.target; _a.position; var children = _a.children;
    var isXl = useMatchBreakpoints().isXl;
    var isMobile = isXl === false;
    return (React__default['default'].createElement(Container, null,
        target,
        React__default['default'].createElement(DropdownContent, { position: isMobile ? "top" : "bottom" }, children)));
};
...
var Logo = function (_a) {
    var isDark = _a.isDark, props = __rest(_a, ["isDark"]);
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 250 70" }, props),
        React__default['default'].createElement("image", { width: "250", height: "70", href: isDark ? '/images/egg/LogoTextNewDark.png' : '/images/egg/LogoTextNewWhite.png' })));
};
...
var Logo$1 = function (_a) {
    ...
    return (React__default['default'].createElement(Flex, null, isAbsoluteUrl ? (React__default['default'].createElement(StyledLink$1, { as: "a", href: href, "aria-label": "Nuts Gaming home page" }, innerLogo)) : (React__default['default'].createElement(StyledLink$1, { to: href, "aria-label": "Nuts Gaming home page" }, innerLogo))));
};
...
var ConnectModal = function (_a) {
    ...
    return (React__default['default'].createElement(Modal, { title: t('unlockwallet'), onDismiss: onDismiss }, connectors.map(function (entry, index) { return (React__default['default'].createElement(WalletCard, { key: entry.title, login: login, walletConfig: entry, onDismiss: onDismiss, mb: index < connectors.length - 1 ? "8px" : "0" })); })));
};
...
var AccountModal = function (_a) {
    ...
    var t = reactI18next.useTranslation().t;
    return (React__default['default'].createElement(Modal, { title: t('yourwallet'), onDismiss: onDismiss },
        ...
        React__default['default'].createElement(Flex, { mb: "32px" },
            React__default['default'].createElement(LinkExternal, { small: true, href: "https://bscscan.com/address/" + account, mr: "16px" }, t('viewonbscscan')),
            React__default['default'].createElement(CopyToClipboard, { toCopy: account }, t('copyaddress'))),
...
var MoonIcon = Icons.MoonIcon, SunIcon = Icons.SunIcon; Icons.LanguageIcon; Icons.MoreIcon;
styled__default['default'](Dropdown)(templateObject_1$B || (templateObject_1$B = __makeTemplateObject(["\n  ", " {\n    display: block;\n  }\n\n  display: none;\n"], ["\n  ", " {\n    display: block;\n  }\n\n  display: none;\n"])), function (_a) {
    var theme = _a.theme;
    return theme.mediaQueries.sm;
});
var StyledButton$1 = styled__default['default'](Button)(templateObject_2$b || (templateObject_2$b = __makeTemplateObject(["\n  color: #FFFFFF !important;\n  background-color: #ff002a !important;\n"], ["\n  color: #FFFFFF !important;\n  background-color: #ff002a !important;\n"])));
var UserBlock = function (_a) {
    ...
    return (React__default['default'].createElement(Flex, null,
        React__default['default'].createElement(Dropdown, { position: "top-right", target: React__default['default'].createElement(Button, { size: "sm", variant: "text" },
                React__default['default'].createElement(Text, { color: "textSubtle" }, currentLang ? currentLang === null || currentLang === void 0 ? void 0 : currentLang.toUpperCase() : "EN")) }, langs.map(function (lang) { return (React__default['default'].createElement(MenuButton, { key: lang.code, fullWidth: true, onClick: function () { return setLang(lang); }, 
            // Safari fix
            style: { minHeight: "32px", height: "auto" } }, lang.language)); })),
        React__default['default'].createElement(StyledButton$1, { size: "sm", onClick: function () { return toggleTheme(!isDark); } },
            React__default['default'].createElement(Flex, { alignItems: "center" }, isDark ? (React__default['default'].createElement(SunIcon, { color: "white", width: "24px" })) : (React__default['default'].createElement(MoonIcon, { color: "white", width: "24px" })))),
        React__default['default'].createElement(StyledButton$1, { size: "sm", color: "white", onClick: function () {
                buy();
            } },
            React__default['default'].createElement("img", { src: "/images/egg/mastercard.png", width: "60px" })),
        account ? (React__default['default'].createElement(StyledButton$1, { size: "sm", color: "white", onClick: function () {
                onPresentAccountModal();
            } }, accountEllipsis)) : (React__default['default'].createElement(StyledButton$1, { size: "sm", onClick: function () {
...
var Pip = styled__default['default'].div(templateObject_2$c || (templateObject_2$c = __makeTemplateObject(["\n  background-color: ", ";\n  border-radius: 50%;\n  pointer-events: none;\n  height: 8px;\n  position: absolute;\n  right: 0;\n  top: 0;\n  width: 8px;\n"], ["\n  background-color: ", ";\n  border-radius: 50%;\n  pointer-events: none;\n  height: 8px;\n  position: absolute;\n  right: 0;\n  top: 0;\n  width: 8px;\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.failure;
});
...
var StyledNav = styled__default['default'].div(templateObject_2$d || (templateObject_2$d = __makeTemplateObject(["\n  display: grid;\n  grid-template-columns: 1fr 0px;\n  -webkit-box-pack: justify;\n  justify-content: space-between;\n  -webkit-box-align: center;\n  align-items: center;\n  flex-direction: row;\n  width: 100%;\n  top: 0px;\n  position: relative;\n  z-index: 2;\n"], ["\n  display: grid;\n  grid-template-columns: 1fr 0px;\n  -webkit-box-pack: justify;\n  justify-content: space-between;\n  -webkit-box-align: center;\n  align-items: center;\n  flex-direction: row;\n  width: 100%;\n  top: 0px;\n  position: relative;\n  z-index: 2;\n"])));
var StyledNavLeft = styled__default['default'].nav(templateObject_3$6 || (templateObject_3$6 = __makeTemplateObject(["\n  top: 0;\n  left: 0;\n  transition: top 0.2s;\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  padding-left: 24px;\n  padding-right: 16px;\n  height: ", "px;\n  z-index: 20;\n  transform: translate3d(0, 0, 0);\n  width: fit-content;\n  @media only screen and (max-width: 960px) {\n    width: 100%\n\t}\n"], ["\n  top: 0;\n  left: 0;\n  transition: top 0.2s;\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  padding-left: 24px;\n  padding-right: 16px;\n  height: ", "px;\n  z-index: 20;\n  transform: translate3d(0, 0, 0);\n  width: fit-content;\n  @media only screen and (max-width: 960px) {\n    width: 100%\n\t}\n"])), MENU_HEIGHT);
var StyledNavRight = styled__default['default'].nav(templateObject_4$2 || (templateObject_4$2 = __makeTemplateObject(["\n  display: flex;\n  justify-self: flex-end;\n  @media only screen and (max-width: 960px) {\n    position: fixed;\n    bottom: 0;\n    left: 0;\n    transition: bottom 0.2s;\n    width: 100%;\n    justify-content: space-between;\n    align-items: center;\n    height: ", "px;\n    border-top: solid 2px rgba(133, 133, 133, 0.1);\n    z-index: 20;\n    background-color:  ", ";\n\t}\n"], ["\n  display: flex;\n  justify-self: flex-end;\n  @media only screen and (max-width: 960px) {\n    position: fixed;\n    bottom: 0;\n    left: 0;\n    transition: bottom 0.2s;\n    width: 100%;\n    justify-content: space-between;\n    align-items: center;\n    height: ", "px;\n    border-top: solid 2px rgba(133, 133, 133, 0.1);\n    z-index: 20;\n    background-color:  ", ";\n\t}\n"])), MENU_HEIGHT, function (_a) {
    var theme = _a.theme;
...
var StyledNavLink = styled__default['default'].div(templateObject_8 || (templateObject_8 = __makeTemplateObject(["\n  display: flex;\n  align-items: center;\n  width: fit-content;\n  font-weight 500;\n  color: #C3C5CB;\n  margin: 0px 16px;\n  &:hover {\n    text-decoration: underline;\n  }\n  @media only screen and (max-width: 500px) {\n    display: none;\n\t}\n"], ["\n  display: flex;\n  align-items: center;\n  width: fit-content;\n  font-weight 500;\n  color: #C3C5CB;\n  margin: 0px 16px;\n  &:hover {\n    text-decoration: underline;\n  }\n  @media only screen and (max-width: 500px) {\n    display: none;\n\t}\n"])));
styled__default['default'].div(templateObject_9 || (templateObject_9 = __makeTemplateObject(["\n  display: flex;\n  align-items: center;\n  width: fit-content;\n  font-size: 1.2rem;\n  font-weight 600;\n  color: #FFFFFF;\n  margin-left: 24px;\n  margin-right: 12px;\n"], ["\n  display: flex;\n  align-items: center;\n  width: fit-content;\n  font-size: 1.2rem;\n  font-weight 600;\n  color: #FFFFFF;\n  margin-left: 24px;\n  margin-right: 12px;\n"])));
var StyledLinkContainer = styled__default['default'].div(templateObject_10 || (templateObject_10 = __makeTemplateObject(["\n  display: flex;\n  @media only screen and (max-width: 960px) {\n    width: 100%;\n    padding: 1rem 0px 1rem 1rem;\n    justify-content: flex-end;\n\t}\n"], ["\n  display: flex;\n  @media only screen and (max-width: 960px) {\n    width: 100%;\n    padding: 1rem 0px 1rem 1rem;\n    justify-content: flex-end;\n\t}\n"])));
var Icons$1 = IconModule;
Icons$1.MoonIcon; Icons$1.SunIcon; Icons$1.LanguageIcon; var MoreIcon = Icons$1.MoreIcon;
var MobileDropdown = styled__default['default'](Dropdown)(templateObject_11 || (templateObject_11 = __makeTemplateObject(["\n  ", " {\n    display: block;\n  }\n\n  display: none;\n"], ["\n  ", " {\n    display: block;\n  }\n\n  display: none;\n"])), function (_a) {
    var theme = _a.theme;
    return theme.mediaQueries.sm;
});
var Menu = function (_a) {
    var _b;
    var account = _a.account, login = _a.login, logout = _a.logout, isDark = _a.isDark, buy = _a.buy, toggleTheme = _a.toggleTheme, langs = _a.langs, setLang = _a.setLang, currentLang = _a.currentLang; _a.cakePriceUsd; var links = _a.links; _a.priceLink; var profile = _a.profile, children = _a.children;
    var t = reactI18next.useTranslation().t;
    var isXl = useMatchBreakpoints().isXl;
    var isMobile = isXl === false;
    ...
    return (React__default['default'].createElement(Wrapper$1, null,
        React__default['default'].createElement(StyledNav, null,
            React__default['default'].createElement(StyledNavLeft, { showMenu: showMenu },
                React__default['default'].createElement(Logo$1, { isPushed: isPushed, togglePush: function () { return setIsPushed(function (prevState) { return !prevState; }); }, isDark: isDark, href: (_b = homeLink === null || homeLink === void 0 ? void 0 : homeLink.href) !== null && _b !== void 0 ? _b : "/" }),
                React__default['default'].createElement(StyledLinkContainer, null,
                    React__default['default'].createElement(StyledNavLink, { as: "a", href: "https://charts.bogged.finance/?token=0xe6e6a022b4d4e538ca0a1f47941cbbf3f9cc1467" },
                        React__default['default'].createElement(Text, { fontSize: "20px" }, t('menuchart'))),
                    React__default['default'].createElement(StyledNavLink, { as: "a", href: "https://nutsgaming.net/#tokenomics" },
                        React__default['default'].createElement(Text, { fontSize: "20px" }, t('menuabout'))),
                    React__default['default'].createElement(MobileDropdown, { position: "top-right", target: React__default['default'].createElement(Button, { size: "sm", variant: "text", startIcon: React__default['default'].createElement(MoreIcon, { color: "textSubtle", width: "24px" }) }) }, sharelinks.map(function (link) { return (React__default['default'].createElement(MenuButton, { key: link.name, fullWidth: true, onClick: function () { return goToLink(link.url); }, 
                        // Safari fix
                        style: { minHeight: "32px", height: "auto" } }, link.name)); })))),
            React__default['default'].createElement(StyledNavRight, null,
                React__default['default'].createElement(Flex, null,
                    React__default['default'].createElement(UserBlock, { account: account, login: login, logout: logout, buy: buy, toggleTheme: toggleTheme, isDark: isDark, langs: langs, setLang: setLang, currentLang: currentLang }),
                    profile && React__default['default'].createElement(Avatar, { profile: profile })))),
        React__default['default'].createElement(BodyWrapper, null,
            React__default['default'].createElement(Inner, { isPushed: isPushed, showMenu: showMenu }, children))));
};
var templateObject_1$D, templateObject_2$d, templateObject_3$6, templateObject_4$2, templateObject_5$1, templateObject_6, templateObject_7, templateObject_8, templateObject_9, templateObject_10, templateObject_11;
...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#FAF9FA", backgroundDisabled: "#758994", bgimage: "images/bg-light.jpg", contrast: "#191326", invertedContrast: "#FFFFFF", input: "#eeeaf4", tertiary: "#dceaf1", text: "#ff992a", textDisabled: "#BDC2C4", textSubtle: "#8f80ba", borderColor: "#E9EAEB", card: "#00000080", gradients: {
        bubblegum: "linear-gradient(139.73deg, #E6FDFF 0%, #F3EFFF 100%)",
    } });
var darkColors = __assign(__assign(__assign({}, baseColors), brandColors), { secondary: "#9A6AFF", background: "#343135", bgimage: "images/bg-dark.jpg", backgroundDisabled: "#3c3742", contrast: "#FFFFFD", invertedContrast: "#191327", input: "#10161C", primaryDark: "#0098A1", tertiary: "#343a40", text: "#FFFFFF", textDisabled: "#666171", textSubtle: "#c9c4d4", borderColor: "#524B63", card: "#1e262f4d", gradients: {
